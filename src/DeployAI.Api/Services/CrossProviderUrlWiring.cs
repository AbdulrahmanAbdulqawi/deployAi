...
internal static class CrossProviderUrlWiring
{
    ...
    /// <summary>Resolves which wiring mode a website+server pair needs, based on their frameworks.</summary>
    ...
    /// <summary>Whether a website+server pair needs split-origin wiring (Angular + .NET, direct cross-origin API calls with CORS).</summary>
