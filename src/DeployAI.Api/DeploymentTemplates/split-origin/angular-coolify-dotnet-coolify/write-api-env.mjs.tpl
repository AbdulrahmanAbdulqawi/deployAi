...
if (!apiBaseUrl && (process.env.CI === 'true' || process.env.NODE_ENV === 'production')) {
  console.error('Missing {{apiEnvKeysList}} for production build. API requests will hit the website host and fail.');
  process.exit(1);
}
